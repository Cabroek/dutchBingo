...
namespace Bingo
{
    class Program
    {
        ...
        private static void CommandLoop()
        {
            string command = "";
            string[] commandWords;
            Console.Write("Welcome to Connor's Dutch Bingo Parlor!\n");
            ...
            while (command != "exit")
            {
                ...
                // illegal command
                    ...
                    Console.Write("\nLegal commands: read [filename], dump, show [personname],\n orphans, siblings [personname], descendants [personname], cousins [personname] [degree] [removed] bingo [personname1] [personname2] exit\n");
            }
        }
